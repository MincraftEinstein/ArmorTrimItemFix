...
public record TrimmableItemData(Item item, EquipmentType type, Optional<Identifier> overrideId,
                                Map<String, Identifier> layers, List<ItemTintSource> tintSources) {

    private static final List<String> VALID_LAYERS = List.of("layer0", "layer1", "layer2", "layer3");

    private static final Codec<Map<String, Identifier>> LAYER_CODEC = Codec.unboundedMap(Codec.STRING.validate(string ->
    ...
    public static final Codec<TrimmableItemData> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Identifier.CODEC.optionalFieldOf("override_id").forGetter(TrimmableItemData::overrideId),
